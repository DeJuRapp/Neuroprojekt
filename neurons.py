...
class Neuron():
  ...
  @staticmethod
  def propagate(x:np.ndarray, w:np.ndarray, **kwargs) -> np.ndarray:
    '''
    Propagates the input through a set of neurons defined by the array w.
    '''

  @staticmethod
  def back_propagate(x:np.ndarray, w:np.ndarray, y:np.ndarray, derivatives:np.ndarray, **kwargs) -> Tuple[np.ndarray, np.ndarray]:
    '''
    Returns the derivatives for w and x.
    '''

  @staticmethod
  def adapt(w:np.ndarray, d_w:np.ndarray, train_rate:float, **kwargs) -> np.ndarray:
    '''
...
class RBF(Neuron):
  @staticmethod
  def propagate(x:np.ndarray, c:np.ndarray, **kwargs) -> np.ndarray:
    '''
    ...
    '''
    standard_deviation = kwargs.get("standard_deviation", 1.0)
  ...
  @staticmethod
  def back_propagate(x:np.ndarray, c:np.ndarray, y:np.ndarray, derivatives:np.ndarray, **kwargs) -> Tuple[np.ndarray, np.ndarray]:
    '''
